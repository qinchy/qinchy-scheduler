...
replace (
	...
	k8s.io/controller-manager => ../../../k8s.io/kubernetes/kubernetes/staging/src/k8s.io/controller-manager
	...
	k8s.io/mount-utils => ../../../k8s.io/kubernetes/kubernetes/staging/src/k8s.io/mount-utils
	k8s.io/pod-security-admission => ../../../k8s.io/kubernetes/kubernetes/staging/src/k8s.io/pod-security-admission
